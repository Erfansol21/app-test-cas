...
class BudgetFriendlyStrategyTest {
    ...
    @Test
    void testBudgetFriendlyStrategyPrioritizesLowCostPerCalorie() {
        Product p1 = createProduct(1, "Apple", 100, 1, 1.0);
        Product p2 = createProduct(2, "Chicken", 200, 1, 5.0);
        Product p3 = createProduct(3, "Beans", 150, 1, 2.0);
        ...
        // Apple is cheapest per calorie, should be included
